...
CFLAGS  = -O3
HEADER  = Array.h GArray.h Itemset.h Lists.h Eqclass.h extl2.h
OBJS	= Itemset.o Array.o GArray.o Eqclass.o Lists.o extl2.o partition.o
LIBS = -lm -lc
TARGET  = primeseq calcl2
...
primeseq: sequence.cc $(OBJS) $(HEADER) 
	$(CC) $(CFLAGS) -o primeseq sequence.cc $(OBJS) $(LIBS)
...
GArray.o: GArray.cc GArray.h
	$(CC) $(CFLAGS) -c -o GArray.o GArray.cc 
